...
| [prefer-page-locator-fill](https://github.com/playwright-community/eslint-plugin-playwright/tree/main/docs/rules/prefer-page-locator-fill.md)       | Suggest built-in locators over `page.locator()`                    |     |     |     |
